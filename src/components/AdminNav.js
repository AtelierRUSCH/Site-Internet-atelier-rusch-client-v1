    ...
    return (
      <div className="NavBar" style={{ zIndex: '10000' }}>
        ...
        <div
          ...
          style={{ width: '60vw', padding: '0 2rem' }}
        >
          <Link
          ...
          <Link
            onClick={() => window.scrollTo(0, 0)}
            className={
              window.location.pathname.includes('/admin/articles')
                ? 'NavBarLinkAdmin active'
                : 'NavBarLinkAdmin'
            }
            to="articles"
          ...
          <Link
            onClick={() => window.scrollTo(0, 0)}
            className={
              window.location.pathname.includes('/admin/filtres')
                ? 'NavBarLinkAdmin active'
                : 'NavBarLinkAdmin'
            }
            to="filtres"
          ...
          <Link
            onClick={() => window.scrollTo(0, 0)}
            className={
              window.location.pathname.includes('/admin/equipe')
                ? 'NavBarLinkAdmin active'
                : 'NavBarLinkAdmin'
            }
            to="equipe"
          ...
          <Link
            onClick={() => window.scrollTo(0, 0)}
            className={
              window.location.pathname.includes('/admin/partenaires')
                ? 'NavBarLinkAdmin active'
                : 'NavBarLinkAdmin'
            }
            to="partenaires"
